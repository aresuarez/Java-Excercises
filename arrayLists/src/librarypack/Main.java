...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*tecleados en el libro de modo que habr� que
		...
		break;
		/* Dado un ISBN (que habr� que leer por
		teclado), buscar dicho libro de la biblioteca.
		Puede suceder de que ese libro no est� con
		lo cual habr�a que decir que dicho libro NO
